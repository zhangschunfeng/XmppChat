...
public class SmsOpenHelper1 extends SQLiteOpenHelper{
	...
	public SmsOpenHelper1(Context context) {
		super(context, DB, null, VERSION);
		
	}
	
	public SmsOpenHelper1(Context context, String name, CursorFactory factory,
			int version) {
