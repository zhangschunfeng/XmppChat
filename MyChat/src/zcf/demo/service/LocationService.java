...
public class LocationService {
	...
	public LocationClientOption getDefaultLocationClientOption(){
		if(mOption == null){
			...
			mOption.setScanSpan(3000);//可�?，默�?，即仅定位一次，设置发起定位请求的间隔需要大于等�?000ms才是有效�?		    mOption.setIsNeedAddress(true);//可�?，设置是否需要地�?��息，默认不需�?		    mOption.setIsNeedLocationDescribe(true);//可�?，设置是否需要地�?���?		    mOption.setNeedDeviceDirect(false);//可�?，设置是否需要设备方向结�?		    mOption.setLocationNotify(false);//可�?，默认false，设置是否当gps有效时按�?S1次频率输出GPS结果
